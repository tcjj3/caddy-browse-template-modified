...
<html>
	<head>
		<title>{{html .Name}} - tcjj3 (BG7XUD)</title>
		<meta charset="utf-8">
...
tr {
	...
	border-bottom: 1px dashed hsl(0, 0%, 18.82%);
}
...
@media (max-width: 600px) {
	...
	<body onload='filter()'>
		...
		<footer>
			...
			<br>
			<br>
			<h1>Copyright © <a rel="noopener noreferrer" href="https://github.com/tcjj3">tcjj3 (BG7XUD)</a></h1>
		</footer>
		<script>
